...
# Architecture Flags
parser.add_argument('--intermediate_dim', type=int, default=200)
parser.add_argument('--stripe_dim', type=int, default=15)
parser.add_argument('--num_stripes', type=int, default=10)
parser.add_argument('--percent_active_neurons', type=int, default=.3)
...
class Net(nn.Module):
    def __init__(self, intermediate_dim, stripe_dim, num_stripes, percent_active_neurons, num_active_stripes):
        ...
        self.num_active_neurons = int(percent_active_neurons * stripe_dim * num_stripes)
        self.num_active_stripes = num_active_stripes

    def lifetime_sparsify(self, x):
